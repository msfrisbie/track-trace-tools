...
export enum MessageType {
  ...
  QUICK_ACTION_OPEN = "QUICK_ACTION_OPEN",
  QUICK_ACTION_SUBMIT = "QUICK_ACTION_SUBMIT",
  QUICK_ACTION_SUCCESS = "QUICK_ACTION_SUCCESS",
  QUICK_ACTION_ERROR = "QUICK_ACTION_ERROR",
