...
describe('package.ts', () => {
  it('Extracts delimiter separated values', () => {
    ...
    expect(() => getDelimiterSeparatedValuesOrError('1A4000000000000000001234, 1A400000000000...', {
      regex: METRC_TAG_REGEX,
    })).toThrowError();
    expect(() => getDelimiterSeparatedValuesOrError('foobar', { regex: METRC_TAG_REGEX })).toThrowError();
    expect(() => getDelimiterSeparatedValuesOrError('foobar,foobarbaz', { regex: METRC_TAG_REGEX })).toThrowError();
  });
});
