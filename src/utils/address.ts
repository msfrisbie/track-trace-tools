import { IContactInfo, IMetrcFacilityData, ITagOrderData, ITagOrderModalData } from '@/interfaces';
...
export function extractIContactInfoFromITagOrderModalData(tagOrderModalData: ITagOrderModalData): IContactInfo {
    return {
