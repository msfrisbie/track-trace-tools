...
const SEED_PACKAGE: IPackageHistoryData[] = [
  {
    Descriptions: [
      "Packaged 12 plants",
      "- Plant Batch: Grapefruit F3 10/15/22",
      "- Package Type: Immature Plant",
      "- Location: Seed Vault",
      "- Location Type: Default Location Type",
    ],
    UserName: "Joe Bob (FOO123)",
    ActualDate: "2022-10-15",
    RecordedDateTime: "2022-10-15T17:50:35.4598397Z",
    InputSourcesNames: "User",
    ExternalSourceName: "",
  },
];
...
describe("history.ts", () => {
  ...
  it("Correctly extracts initial quantity", () => {
    ...
    expect(extractInitialPackageQuantityAndUnitFromHistoryOrError(SEED_PACKAGE)).toEqual([
      12,
      "Each",
    ]);
  });
