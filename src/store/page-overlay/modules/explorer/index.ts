...
export const explorerModule = {
  ...
  actions: {
    ...
    [ExplorerActions.SUBMIT_QUERY]: async (
      ...
      analyticsManager.track(AnalyticsEvent.EXPLORER_QUERY, {
        queryString,
        targetType,
      });
      ...
      try {
        ...
        switch (ctx.state.targetType) {
          ...
          case ExplorerTargetType.PACKAGE:
            ...
            if (!pkg) {
              ...
              analyticsManager.track(AnalyticsEvent.EXPLORER_ERROR, {
                queryString,
                targetType,
        ...
        analyticsManager.track(AnalyticsEvent.EXPLORER_SUCCESS, {
          queryString,
          targetType,
        });
      } catch (e) {
