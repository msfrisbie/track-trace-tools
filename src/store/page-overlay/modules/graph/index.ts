import { AnalyticsEvent, PackageState } from "@/consts";
...
export const graphModule = {
  ...
  actions: {
    ...
    [GraphActions.RENDER_GRAPH]: async (
      ...
      analyticsManager.track(AnalyticsEvent.GRAPH_RENDER);
    ...
    [GraphActions.SELECT_NODE]: async (
      ...
      node && analyticsManager.track(AnalyticsEvent.GRAPH_NODE_SELECT);
    },
    [GraphActions.ZOOM]: async (
      ...
      analyticsManager.track(AnalyticsEvent.GRAPH_ZOOM);
    },
    [GraphActions.SET_SEARCH_QUERY]: async (
      ...
      analyticsManager.track(AnalyticsEvent.GRAPH_SEARCH_QUERY, { query });
