          ...
          <template v-if="allDetailsProvided">
            ...
            <b-form-group class="w-full">
              <tag-picker :tagTypeNames="['CannabisPlant', 'MedicalPlant', 'Cannabis Plant', 'Medical Plant']"
                :tagCount="selectedPlantBatches.length" :selectedTags.sync="plantBatchTags" />
            </b-form-group>
        ...
        <template v-if="allDetailsProvided && tagsSelected">
          <div class="flex flex-col items-center">
            <div class="flex flex-col space-y-4 text-xl" style="width: 600px">
              ...
              <b-button class="w-full" variant="success" size="md" @click="submit()">RETAG {{
                selectedPlantBatches.length }} PLANT BATCHES</b-button>
