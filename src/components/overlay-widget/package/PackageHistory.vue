<template>
  <div>
    <div class="flex flex-col items-stretch w-full h-full">
            ...
            <b-tabs card pills align="center" content-class="" nav-wrapper-class="bg-purple-200">
                  ...
                  <b-tab no-body title="List">
                    <div class="p-8">
                      <b-button
                        variant="outline-primary"
                        @click="
                          downloadListCsv(parentList, `${sourcePackage.Label}_parent_list.csv`)
                        "
                        >DOWNLOAD CSV</b-button
                      >
                    </div>
              ...
              <b-tab no-body :title="`Help`"
                ><div class="flex flex-col items-stretch gap-2 p-4">
                  ...
                  <div>
                    For any source package, this tool will progressively search Metrc across
                    multiple licenses to find all the parent packages and all the child packages.
                  </div>
                  ...
                  <div>
                    Metrc package history may include package tags that are not visible to any of
                    your licenses. These tags are shown here for convenience.
                  </div>
                  ...
                  <div>
                    Use the <span class="font-bold">Generation limit</span> field for faster
                    results.
                  </div>
                  <div>
                  ...
                  <div>
                    The <span class="font-bold">Child Packages view</span> shows all the packages
                    that were produced from the source package.
                  </div>
                  ...
                  <div>
                    The <span class="font-bold">List view</span> combines the entire history tree
                    into a single list. Parent/child packages will only appear once.
                  </div>
                </div>
              </b-tab>
            </b-tabs>
      ...
      <div class="bg-white sticky bottom-0" v-if="sourcePackage">
        <template>
