    ...
    <g class="animate-fill" v-bind:style="{ fill: fill }">
      <template v-if="inverted">
        ...
        <g
          ...
          transform="matrix(0.773148091634573,0,0,0.773148091634573,28.32755635485929,28.680957755084535)"
          fill="#ffffff"
        >
