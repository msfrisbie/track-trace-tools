<template>
  <b-button variant="primary" title="Report a Bug" id="bug-report-popover-target" class="cursor-pointer"
    style="padding: 0"
    ...
    <b-popover target="bug-report-popover-target" triggers="hover" placement="top" variant="light"
      ref="bug-report-popover" :disabled="trackedInteractions.dismissedBugReportsPopover" container="popover-container">
      <template #title>
      ...
      <div style="min-width: 200px" class="flex flex-col space-y-2 text-base">
        ...
        <b-button size="sm" variant="outline-primary" class="mb-2" @click="dismissBugReportPopover()">GOT IT</b-button>
      </div>
    </b-popover>
  </b-button>
</template>
